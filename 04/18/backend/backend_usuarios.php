    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="backend_alunos.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h2>Manutenção de Usuários <button class="btn btn-success">Cadastrar usuarios</button></h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm">
                                            <a style="text-decoration: none; color: white;" href="excluir_alunos.php ? id_usuario=<?php echo $usuario["id"];  ?>">
                                                Excluir</a>
                                        </button>
                                    </td>
